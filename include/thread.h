...
struct thread {
	...
	//flag to know if wait_pid function is called
...
/*Rerurn pointer of thread by given pid*/
struct thread * pid_get_thread(pid_t pid);
...
/*
 * Copy of thread_wakup.Use for singal.Only wake up the first thread on sleep queue
 */
